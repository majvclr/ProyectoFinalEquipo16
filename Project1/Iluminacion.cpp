...
// Light 2 attributes
glm::vec3 lightPos2(0.3f, 0.3f, 1.5f);
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light.diffuse"), 0.8f, 0.8f, 0.1f);
        ...
        glUniform3f(lightPosLoc2, lightPos2.x + movelightPos1, lightPos2.y + movelightPos1, lightPos2.z + movelightPos1);
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light2.ambient"), 0.3f, 0.3f, 0.3f);
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light2.diffuse"), 0.8f, 0.8f, 0.1f);
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.ambient"), 0.8f, 0.3f, 0.5f);
        ...
        //2da Luz
        model = glm::mat4(1.0f);
        model = glm::translate(model, lightPos2 + movelightPos1);
        model = glm::scale(model, glm::vec3(0.3f));
        glUniformMatrix4fv(glGetUniformLocation(lampshader.Program, "model"), 1, GL_FALSE, glm::value_ptr(model));
        red_dog.Draw(lightingShader);
        //glDrawArrays(GL_TRIANGLES, 0, 36);
